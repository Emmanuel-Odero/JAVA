public class java_comments {
    public static void main(String[ ] args){
        System.out.println("Coments are used to add notes to your java code and making them more readable");
    //This is a single line comment it wont be printed to the screen
